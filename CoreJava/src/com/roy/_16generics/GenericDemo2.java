...
public class GenericDemo2 {
    ...
    // Example of multiple bounds - upper bounded parameterization
    // we can also extend or implement two interfaces as shown below
    // during compilation the signature changes to
    // public static Comparable maxValue(T x, T y, T z)
