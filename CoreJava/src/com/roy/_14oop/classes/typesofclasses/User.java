...
import com.roy._14oop.classes.Product;

/*
    CONCRETE CLASS - has all implementation

    final keyword before class - we cannot extend this class (no inheritance)
    eg: String class is also a final class
 */
