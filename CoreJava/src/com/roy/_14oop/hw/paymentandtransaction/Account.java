package com.roy._14oop.hw.paymentandtransaction;

import java.util.Arrays;

public class Account {

    private static final int DEFAULT_TRANSACTIONS_SIZE = 10;
    ...
    {
        transactions = new Transaction[DEFAULT_TRANSACTIONS_SIZE];
    }
