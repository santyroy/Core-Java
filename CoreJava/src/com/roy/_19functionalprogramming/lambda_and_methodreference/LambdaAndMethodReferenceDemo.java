...
public class LambdaAndMethodReferenceDemo {
    public static void main(String[] args) {
        ...
        orderManagement.setDistanceCalculator((city1, city2) -> 5.52); //** replace dCalculator object with lambda


        // ==== Method Reference Demo ====
        // If we want to use an existing method from other 3rd party library or class which does the
        // same work of that of the implementing class or lambda expression then we can use method reference
