...
public class DefaultMyList implements MyList {
	...
	/**
	 * Unlinks element from the MyListImpl and set new values of first and last
	 * element.
	 * 
	...
	/**
	 * Overrides toString method so result would be in the format {[result of the
	 * toString method for element #1], [result of the toString method for element
	 * #2], ... }
	 * 
	 ...
	 * 
	 * If index more than half of total amount of elements method starts searching
	 * from the end and vice versa.
	 * 
	 * @param index of the element.
	 * @return Node
	 */
